...
const PHASES = [
  {
    ...
    title: "RESISTANCE",
    days: "Days 1 – 4",
    body: "Your brain fights the new neural path. The AI watches. It does not accept excuses.",
  },
  {
    num: "02",
    title: "ADAPTATION",
    days: "Days 5 – 10",
    body: "Discipline stops being a decision. It becomes a default state. You notice the change.",
  },
  {
    num: "03",
    title: "MASTERY",
    days: "Days 11 – 16",
    body: "You are no longer who you were on Day 1. The system has proof. So do you.",
  },
];
      ...
      <FadeUp delay={0.05}>
        <div style={sec}>
          ...
          <h2 style={{
            ...
            The 16-Day<br />
            <span className="hm-shimmer">Arc</span>
          </h2>
          ...
          <div style={{
            ...
            gap: 10,
          }} className="hm-phase-grid">
            {PHASES.map((p, i) => (
              <div key={i} className="hm-phase-card" style={{
                border: "1px solid #161616",
                background: "#0b0b0b",
                padding: "20px 16px",
              }}>
